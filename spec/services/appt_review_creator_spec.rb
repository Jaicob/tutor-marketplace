...
RSpec.describe ApptReviewCreator do
  ...
  describe '#reviews_needed?' do 
    context 'when a student has one or more completed appts without a review' do 
    end

    context 'when a student has no completed appts without a review' do 
    end
  end
  
  describe '#get_appts_to_review' do 
  end
  
  describe '#format_appts_to_review' do 
  end
