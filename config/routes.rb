...
#                                      POST     /api/v1/schools/:school_id/subjects/:subject_id/courses(.:format)          api/v1/courses#create {:format=>:json}
#     new_api_v1_school_subject_course GET      /api/v1/schools/:school_id/subjects/:subject_id/courses/new(.:format)      api/v1/courses#new {:format=>:json}
#    edit_api_v1_school_subject_course GET      /api/v1/schools/:school_id/subjects/:subject_id/courses/:id/edit(.:format) api/v1/courses#edit {:format=>:json}
#         api_v1_school_subject_course GET      /api/v1/schools/:school_id/subjects/:subject_id/courses/:id(.:format)      api/v1/courses#show {:format=>:json}
#                                      PATCH    /api/v1/schools/:school_id/subjects/:subject_id/courses/:id(.:format)      api/v1/courses#update {:format=>:json}
#                                      PUT      /api/v1/schools/:school_id/subjects/:subject_id/courses/:id(.:format)      api/v1/courses#update {:format=>:json}
#                                      DELETE   /api/v1/schools/:school_id/subjects/:subject_id/courses/:id(.:format)      api/v1/courses#destroy {:format=>:json}
#               api_v1_school_subjects GET      /api/v1/schools/:school_id/subjects(.:format)                              api/v1/subjects#index {:format=>:json}
#                                      POST     /api/v1/schools/:school_id/subjects(.:format)                              api/v1/subjects#create {:format=>:json}
#            new_api_v1_school_subject GET      /api/v1/schools/:school_id/subjects/new(.:format)                          api/v1/subjects#new {:format=>:json}
#           edit_api_v1_school_subject GET      /api/v1/schools/:school_id/subjects/:id/edit(.:format)                     api/v1/subjects#edit {:format=>:json}
#                api_v1_school_subject GET      /api/v1/schools/:school_id/subjects/:id(.:format)                          api/v1/subjects#show {:format=>:json}
#                                      PATCH    /api/v1/schools/:school_id/subjects/:id(.:format)                          api/v1/subjects#update {:format=>:json}
#                                      PUT      /api/v1/schools/:school_id/subjects/:id(.:format)                          api/v1/subjects#update {:format=>:json}
#                                      DELETE   /api/v1/schools/:school_id/subjects/:id(.:format)                          api/v1/subjects#destroy {:format=>:json}
#                       api_v1_schools GET      /api/v1/schools(.:format)                                                  api/v1/schools#index {:format=>:json}
#                                      POST     /api/v1/schools(.:format)                                                  api/v1/schools#create {:format=>:json}
#                    new_api_v1_school GET      /api/v1/schools/new(.:format)                                              api/v1/schools#new {:format=>:json}
#                   edit_api_v1_school GET      /api/v1/schools/:id/edit(.:format)                                         api/v1/schools#edit {:format=>:json}
#                        api_v1_school GET      /api/v1/schools/:id(.:format)                                              api/v1/schools#show {:format=>:json}
#                                      PATCH    /api/v1/schools/:id(.:format)                                              api/v1/schools#update {:format=>:json}
#                                      PUT      /api/v1/schools/:id(.:format)                                              api/v1/schools#update {:format=>:json}
#                                      DELETE   /api/v1/schools/:id(.:format)                                              api/v1/schools#destroy {:format=>:json}
...
Rails.application.routes.draw do
  ...
  get '/restricted_access_page' => 'single_views#restricted_access_page'
