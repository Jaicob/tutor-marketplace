...
#           dashboard_home_user GET    /users/:id/dashboard/home(.:format)                       dashboard/home#index
#       dashboard_schedule_user GET    /users/:id/dashboard/schedule(.:format)                   dashboard/schedule#index
#        dashboard_courses_user GET    /users/:id/dashboard/courses(.:format)                    dashboard/courses#index
#        dashboard_profile_user GET    /users/:id/dashboard/profile(.:format)                    dashboard/profile#index
#   dashboard_edit_profile_user GET    /users/:id/dashboard/edit_profile(.:format)               dashboard/profile#edit
#       dashboard_settings_user GET    /users/:id/dashboard/settings(.:format)                   dashboard/settings#index
#         dashboard_tutors_user GET    /users/:id/dashboard/tutors(.:format)                     dashboard/tutors#index
#                          user PATCH  /users/:id(.:format)                                      users#update
#                               PUT    /users/:id(.:format)                                      users#update
#          admin_school_courses GET    /admin/schools/:school_id/courses(.:format)               admin/courses#index
#                               POST   /admin/schools/:school_id/courses(.:format)               admin/courses#create
#       new_admin_school_course GET    /admin/schools/:school_id/courses/new(.:format)           admin/courses#new
#      edit_admin_school_course GET    /admin/schools/:school_id/courses/:id/edit(.:format)      admin/courses#edit
#           admin_school_course GET    /admin/schools/:school_id/courses/:id(.:format)           admin/courses#show
#                               PATCH  /admin/schools/:school_id/courses/:id(.:format)           admin/courses#update
#                               PUT    /admin/schools/:school_id/courses/:id(.:format)           admin/courses#update
#                               DELETE /admin/schools/:school_id/courses/:id(.:format)           admin/courses#destroy
#           admin_school_tutors GET    /admin/schools/:school_id/tutors(.:format)                admin/tutors#index
#                               POST   /admin/schools/:school_id/tutors(.:format)                admin/tutors#create
#        new_admin_school_tutor GET    /admin/schools/:school_id/tutors/new(.:format)            admin/tutors#new
#       edit_admin_school_tutor GET    /admin/schools/:school_id/tutors/:id/edit(.:format)       admin/tutors#edit
#            admin_school_tutor GET    /admin/schools/:school_id/tutors/:id(.:format)            admin/tutors#show
#                               PATCH  /admin/schools/:school_id/tutors/:id(.:format)            admin/tutors#update
#                               PUT    /admin/schools/:school_id/tutors/:id(.:format)            admin/tutors#update
#                               DELETE /admin/schools/:school_id/tutors/:id(.:format)            admin/tutors#destroy
#         admin_school_students GET    /admin/schools/:school_id/students(.:format)              admin/students#index
#                               POST   /admin/schools/:school_id/students(.:format)              admin/students#create
#      new_admin_school_student GET    /admin/schools/:school_id/students/new(.:format)          admin/students#new
#     edit_admin_school_student GET    /admin/schools/:school_id/students/:id/edit(.:format)     admin/students#edit
#          admin_school_student GET    /admin/schools/:school_id/students/:id(.:format)          admin/students#show
#                               PATCH  /admin/schools/:school_id/students/:id(.:format)          admin/students#update
#                               PUT    /admin/schools/:school_id/students/:id(.:format)          admin/students#update
#                               DELETE /admin/schools/:school_id/students/:id(.:format)          admin/students#destroy
#     admin_school_appointments GET    /admin/schools/:school_id/appointments(.:format)          admin/appointments#index
#                               POST   /admin/schools/:school_id/appointments(.:format)          admin/appointments#create
#  new_admin_school_appointment GET    /admin/schools/:school_id/appointments/new(.:format)      admin/appointments#new
# edit_admin_school_appointment GET    /admin/schools/:school_id/appointments/:id/edit(.:format) admin/appointments#edit
#      admin_school_appointment GET    /admin/schools/:school_id/appointments/:id(.:format)      admin/appointments#show
#                               PATCH  /admin/schools/:school_id/appointments/:id(.:format)      admin/appointments#update
#                               PUT    /admin/schools/:school_id/appointments/:id(.:format)      admin/appointments#update
#                               DELETE /admin/schools/:school_id/appointments/:id(.:format)      admin/appointments#destroy
#            admin_school_slots GET    /admin/schools/:school_id/slots(.:format)                 admin/slots#index
#                               POST   /admin/schools/:school_id/slots(.:format)                 admin/slots#create
#         new_admin_school_slot GET    /admin/schools/:school_id/slots/new(.:format)             admin/slots#new
#        edit_admin_school_slot GET    /admin/schools/:school_id/slots/:id/edit(.:format)        admin/slots#edit
#             admin_school_slot GET    /admin/schools/:school_id/slots/:id(.:format)             admin/slots#show
#                               PATCH  /admin/schools/:school_id/slots/:id(.:format)             admin/slots#update
#                               PUT    /admin/schools/:school_id/slots/:id(.:format)             admin/slots#update
#                               DELETE /admin/schools/:school_id/slots/:id(.:format)             admin/slots#destroy
#             home_admin_school GET    /admin/schools/:id/home(.:format)                         admin/home#index
