redis_domain = ENV['VAGRANT_REDIS_1_PORT_6379_TCP_ADDR'] || ENV['WEBAPP_REDIS_1_PORT_6379_TCP_ADDR'] || ENV['AXON_REDIS_1_PORT_6379_TCP_ADDR'] || ENV['REDIS_PRODUCTION_ADDR']
