...
class Tutor < ActiveRecord::Base
  ...
  #
  # Limit the fields being returned in the json repsonse and add students and appointments fields
  # TODO: remove approval once part of model
  #
  def as_json(options = {})
    ...
    tutor[:appointments]  = tutor_stats.total_appts.count
    tutor[:students]      = tutor_stats.students.count
    tutor[:approval]      = tutor_stats.approval
    return tutor
  end
